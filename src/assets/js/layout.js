import Vue from 'vue'
import md5 from './md5.min.js' // 若需要md5密码
...
export default {
	...
	install: function(Vue){
        ...
        // 加载
        // 显示loading
        Vue.prototype.loading = function(type, text = 'Loading...') {
        ...
        Vue.prototype.wDialog = function(title, content, cancelButtonText, confirmButtonText, showConfirmButton, cb_ok, cb_err) {
